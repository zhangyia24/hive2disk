...
object saveIS {
  def main(args: Array[String]): Unit = {
    ...
    try {
      ...
      val frame: DataFrame = hiveContext.sql("select * from bdm.dayima_search_log order by search_time desc limit 10000")
      frame.write.csv("e://demo01"+System.currentTimeMillis())
